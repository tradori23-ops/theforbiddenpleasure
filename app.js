...
function renderChatSidebar(threads){
  ...
  threads.forEach(function(th){
    ...
    row.innerHTML =
      ...
      '</span>';
    row.addEventListener('click', function(){ openChatWithUser(st.otherId, true); });
    list.appendChild(row);
